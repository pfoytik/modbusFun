...
char system_active = '0';  // '0' is inactive, '1' is active
...
void loop() {
  ...
  // **Check for Serial Commands from Modbus**
  ...
  // TODO: set parameters based on system_active , '0' is inactive '1' is active
